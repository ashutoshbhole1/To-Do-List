...
import { Mail, Phone, MapPin, Github, Linkedin, MessageCircle, Clock, Send, MessageSquare,MessageSquareShare } from 'lucide-react';
	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'ashutoshbhole1@gmail.com',
			link: 'ashutoshbhole1@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+919303580738',
			link: 'tel:+919303580738'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/ashutoshbhole1'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://linkedin.com/in/ashutoshbholeofficial'
		},
		{
			icon: <MessageSquareShare className="w-5 h-5" />,
			// icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+919303580738'
		}
	];
